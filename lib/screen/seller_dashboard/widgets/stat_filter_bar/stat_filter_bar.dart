...
class StatFilterBar extends StatelessWidget {
  StatFilterBar({super.key});

  final controller = Get.find<StatFilterController>();

  @override
  Widget build(BuildContext context) {
    return GetBuilder<StatFilterController>(
      builder: (controller) {
        return Row(
          children: StatFilterController.filters.map((filter) {
